				...
				<div id="menu3" class="tab-pane fade">
					...
					<div class="table-responsive">
						<table   class="table table-hover table-bordered" >
							...
							<?php
//reading student details
							$resul=mysql_query("select studid,name,mobile_phno from current_class,stud_details where admissionno=studid and classid='$classid' and studid not in(select adm_no from stud_sem_registration where stud_sem_registration.classid='$classid') order by name") or die(mysql_error());
							$serial_no = 0;
							while($dat=mysql_fetch_array($resul))
								{$serial_no++;
								$adm_no=$dat["studid"];
