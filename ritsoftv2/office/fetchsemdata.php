...
//reading registration details from stud_sem_registration 
				$resul=mysql_query("select s.reg_id,s.adm_no,s.classid,s.apl_status,s.previous_sem,s.new_sem,s.apv_status,s.remarks from stud_sem_registration s,current_class c where s.classid='$classid'and s.classid=c.classid and c.studid=s.adm_no and s.apv_status='Approved by HOD' order by c.rollno ");
...
//check student semester registration approval status 
							if($apv_status!="Approved by office") { 
								...
								<div class="btn-group">
									<a  onclick="return confirm('Do you really want to verify this request?');"  href="semregedit.php?id=<?php echo $reg_id;?>&id2=1&id3=<?php echo $classid ?>"><font color="green">Admitted</font></a> | 
									<a href="#" onclick="setid(<?php echo $reg_id;?>,'<?php echo $classid ?>')"  
										data-toggle="modal" data-target="#myModal"
										><font color="red">Reject</font></a> |
										<a  onclick="return confirm('Do you really want to verify this request?');"  href="semregedit.php?id=<?php echo $reg_id;?>&id2=21&id3=<?php echo $classid ?>"><font class="text-info">Provisionally Admitted</font></a> 
