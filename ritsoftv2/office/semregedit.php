...
<form method="post" id="form1" action="sem_verification.php">
...
//1. archiving current class details
				...
				mysql_query("insert into current_classold(classid,studid,rollno,year) select classid,studid,rollno,'$acd_year' from current_class where classid='$classid' and studid='$studid'") or die(mysql_error());
