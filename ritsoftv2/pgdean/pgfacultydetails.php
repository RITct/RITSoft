...
$sql = "SELECT * FROM faculty_details WHERE name='$add_no' and fid not like 'DUMMY%'";
//echo $sql;
...
echo "<table align='center'>";
    ...
    echo '<tr><td><img src="data:image/jpeg;base64,'.base64_encode( $row['photo'] ).'" width="200" height="200" onerror="this.onerror=null;this.src=\'../vendor/images/default.png\';" /></td>';
        echo '<td> <a style=" position: absolute; top: 10%; right: 3%; " class="btn btn-sm btn-info" href="pgfacultysearch.php">BACK</a> </td></tr>';
