<?php
    if(isset($_POST['excel']))
    {
        ...
        $sql = "SELECT * FROM stud_details WHERE ($category='$add_no' AND status like 'On Going') AND (courseid LIKE 'mca' OR courseid LIKE 'mtech')";
...
// rename the sheet
$objSheet->setTitle('PG STUDENT DETAILS');
