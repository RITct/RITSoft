...
//update curent class status of semregstatus table...

        mysql_query("update semregstatus set current_class=0 where curr_sem='$curr_sem' and next_sem='$next_sem'") or die(mysql_error());
        mysql_query("update semregstatus set current_class=1 where curr_sem='$next_sem'") or die(mysql_error());
...
//archiving stud semester registration details.........
...
//deleting details after registration.........

mysql_query("delete from stud_sem_registration where classid='$curr_sem'") or die(mysql_error());

//deleting details from current_class_semreg table based on new classid..

mysql_query("delete from current_class_semreg where classid='$next_sem'") or die(mysql_error());
