...
if(isset($_POST['add_no']))
{
    ...
    $sql = "SELECT * FROM stud_details A LEFT JOIN current_class B ON A.admissionno=B.studid LEFT JOIN class_details C ON B.classid=C.classid WHERE C.courseid='$search_query[0]' AND C.semid='$search_query[1]' AND C.deptname='$search_query[3]' AND C.branch_or_specialisation='$search_query[2]' AND (A.courseid LIKE 'mca' OR A.courseid LIKE 'mtech') ORDER BY B.rollno";
        ...
        if(mysqli_num_rows($result) > 0){
            ...
            while($row = mysqli_fetch_array($result)){
			   ...
			   echo "<td>" . $row['rollno'] . "</td>";
				...
				echo "<td> <a target='_blank' href=pgclassdetails.php?id=".rawurlencode($row['admissionno']).">View </a></td>";
				echo "</tr>";
            }
