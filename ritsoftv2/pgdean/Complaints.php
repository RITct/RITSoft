...
<div id="page-wrapper">
            ...
            <?php
			$query="select id_com,subject,content,com_time,response,res_time from complaint where fid='$fid' and designation='pgdean' and status=1 order by com_time desc";
