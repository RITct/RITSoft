...
<div class="wrapper">
	...
	<div id="page-wrapper">
		...
		//$percent=0;
							...
							?>
							<td align=center><?php echo round(($percent*100),2); ?></td>
							<?php
						}
						?>    
						<td align=center><?php 
			...
			?>
			<a target="_blank" href="pgdean_xl.php?cls=<?php echo $classid; ?>&e=<?php echo $date1; ?>&f=<?php echo $date2; ?>">Export to Excel</a>
