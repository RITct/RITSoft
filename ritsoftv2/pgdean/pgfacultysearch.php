...
$(document).ready(function(){
 ...
 //......................................................................   
    $('#add_no').on("keyup input", function(){
        ...
        if(add_no.length){
            $.get("pgfacultybackend.php", {add_no: add_no,category:category}).done(function(data){
    ...
    <div class="row">
      <div class="col-md-6">
        <label>
         ...
         <select name="category" class="form-control" id="category" style=" height: 35px">
...
<br>
           <div class="row">
            <div class="col-md-6">
              ...
              <input type="text" class="form-control" autocomplete="off"  id="add_no" name="add_no"/>
