             ...
             <li>
                 <a href="#"><i class="fa fa-search fa-fw"></i> Student Search<span class="fa arrow"</span></a>
                     <ul class="nav nav-second-level">
                        <li>
                            <a href="pgsingle.php">Personal Details</a>
                        </li>
                        <li>
                ...
                <li>
                    <a href="#"><i class="fa fa-search fa-fw"></i> Class Search<span class="fa arrow"</span></a>
                     <ul class="nav nav-second-level">
                        <li>
                            <a href="pgclasssearch.php">Class Details</a>
                        </li>
                        <li>
                            <a href="pgden_view1.php">Attendence Details</a>
                        </li>
                        <li>
                            <a href="pgclasssesssearch.php">Sessional Marks</a>
                        </li>
                    </ul>
                </li>
                <li>
                    <a href="#"><i class="fa fa-search fa-fw"></i> Faculty Search<span class="fa arrow"</span></a>
                     <ul class="nav nav-second-level">
                        <li>
                            <a href="pgfacultysearch.php">Faculty Details</a>
                        </li>
