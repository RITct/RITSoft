...
$sql = "SELECT * FROM faculty_details WHERE name='$add_no' and fid not like 'DUMMY%' and deptname!='COMPUTER APPLICATIONS'";
	//echo $sql;
if($result = mysqli_query($link, $sql)){
    if(mysqli_num_rows($result) > 0){
     ...
     while($row = mysqli_fetch_array($result)){
      ...
      echo '<td> <a style=" position: absolute; top: 10%; right: 3%; " class="btn btn-sm btn-info" href="ugfacultysearch.php">BACK</a> </td>';
      echo "<tr>";
