...
$(document).ready(function(){
 ...
 //......................................................................   
    $('#add_no').on("keyup input", function(){
        ...
        if(add_no.length){
            $.get("certbackend-search.php", {add_no: add_no}).done(function(data){
...
//......................................................................   
    $('#name').on("keyup input", function(){
        ...
        var resultDropdown = $(this).siblings(".result");
        if(name.length){
            $.get("certbackend-search.php", {name: name}).done(function(data){
                // Display the returned data in browser
                resultDropdown.html(data);
            });
        } else{
...
<div id="page-wrapper">
    ...
    <strong>SEARCH BY ADMISSION NO </strong> <input type="varchar"  class="form-control" autocomplete="off" placeholder="Add No" id="add_no"/>
