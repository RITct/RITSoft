...
/**
 * @Author: indran
 * @Date:   2018-09-09 11:29:01
 * @Last Modified by:   indran
 * @Last Modified time: 2018-09-09 11:30:13
 */
...
// apl_status='' AND 
										...
										$qx=mysql_fetch_assoc($kx);
										echo  $qx["c"]." (Should be Verified by Staff Advisor)"; ?></td>
									</tr>
								...
								<form method="post" action="now_create_pdfnew.php" target="_blank"  download="status">
