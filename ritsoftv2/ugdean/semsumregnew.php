			...
			<div id="menu3" class="tab-pane fade">
				...
				<div class="table-responsive">
					<table   class="table table-hover table-bordered" >
						...
						<?php
//reading student details
						$resul=mysql_query("select studid,name,mobile_phno from current_class_semreg,stud_details where admissionno=studid and classid='$curr_sem' and studid not in(select adm_no from stud_sem_registration where classid='$curr_sem'  ) order by name") or die(mysql_error());
						$serial_no = 0;
						while($dat=mysql_fetch_array($resul))
							{$serial_no++;
								$adm_no=$dat["studid"];
