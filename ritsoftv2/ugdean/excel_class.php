<?php
    if(isset($_POST['excel']))
    {
        ...
        $sql = "SELECT * FROM stud_details A LEFT JOIN current_class B ON A.admissionno=B.studid LEFT JOIN class_details C ON B.classid=C.classid WHERE A.courseid='$search_query[0]' AND C.semid='$search_query[1]' AND C.deptname='$search_query[3]' AND C.branch_or_specialisation='$search_query[2]' AND (A.courseid LIKE 'btech' OR A.courseid LIKE 'barch') ORDER BY B.rollno";
...
// rename the sheet
$objSheet->setTitle('UG STUDENT CLASS DETAILS');
