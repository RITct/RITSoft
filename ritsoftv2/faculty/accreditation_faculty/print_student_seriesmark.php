	...
	<body>
		...
		<div class="map_contact">
			<div class="row">
				...
				<h3 class="tittle my-5 "><center>Print Series mark</center></h3>
				<div class="contact-grids" align="center">

					<div class="col-md-offset-1 col-md-8 contact-grid" style="text-align:center">

						<form method="post" enctype="multipart/form-data" action="pdf_series_mark.php">
								...
								<tbody >
									<tr style="height: 50px;">
										...
										<tr style="height: 50px;">
											...
											<td>
												<input type="submit" id="btnshow" name="btnshow" class="btn btn-primary" action="pdf_series_mark.php" value="Print series mark"  disabled="disabled"/>
											</td>
										</tr>
									</tbody>
								</table>
