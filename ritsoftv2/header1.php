...
<script>document.body.className += ' fade-out';</script>
    ...
    <nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-dark fixed-top">
      <div class="container">
        <a class="navbar-brand"><img class="img-fulid" src="images/logo.png" alt="RIT" style="width:50px" id='Logo'></a></a><h3 style="color :#007bff ; font-family: 'Berkshire Swash', cursive;" ><span style="color :white;">RIT</span>Soft <span style="color :red;">v2</span></h3>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              ...
              <button class="btn btn-primary"  onclick="window.location.href='admission.php#data'">Home</button>
            </li>

            <li class="nav-item">
       
          <button class="btn btn-primary"  onclick="window.location.href='stud-application.php#data'">Generate PDF</button>
            </li>

            <li class="nav-item">
       
              <button class="btn btn-primary"  onclick="window.location.href='logout.php#data'">Logout</button>
            </li>
