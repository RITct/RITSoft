...
<div id="page-wrapper">
  <div class="row">
    <div class="col-lg-12">
      <h1 class="page-header" align="center"><span>Student Details</span></h1>
    </div>
  </div>
...
echo '<td> <button style=" position: absolute; top: 10%; right: 3%; " class="btn btn-sm btn-info" onClick="window.close();">BACK</button> </td>';
