...
//reading registration details
            $resul=mysql_query("select reg_id,adm_no,classid,apl_status,previous_sem,new_sem,apv_status,remarks from stud_sem_registration where classid='$classid' and (apv_status='Rejected by office' or apv_status='Approved by staff advisor')");
                        ...
                        if($apv_status!="Approved by staff advisor")
                         { ?>
                           ...
                           <br><div class="btn-group">
                            <a  onclick="return confirm('Do you really want to verify this request?');"  href="semregeditnew.php?id=<?php echo $reg_id;?>&id2=1&id3=<?php echo $classid ?>"><font color="green">Verify</font></a> | 
