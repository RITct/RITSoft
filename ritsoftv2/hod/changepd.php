...
<tr>
  ...
  <td>
  <input type="password" class="form-control" name="password2" placeholder="New Password" required pattern="^[A-Za-z0-9@.\s]{5,50}$" title="Text contains only AlphaNumeric ,Space ,@ and Period" /> 
  </td>
</tr>
<tr>

<td>
<input type="password" class="form-control" name="password3" placeholder="Re-enter New Password" required pattern="^[A-Za-z0-9@.\s]{5,50}$" title="Text contains only AlphaNumeric ,Space ,@ and Period" /> 
</td>
</tr>
<tr>
