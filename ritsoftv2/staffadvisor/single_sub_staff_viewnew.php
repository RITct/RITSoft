   ...
   <div class="container">
    ...
    <div class="contact-grids" align="center">
     ...
     <div class="col-md-8 contact-grid" style="text-align:center">
      <form method="post" enctype="multipart/form-data" action="single_sub_staff_viewnew.php"><br><br><br>
        ...
        <table  align="center" width="700" class="table table-hover table-bordered">
          ...
          Class</label></td><td>
            <select name="class" onChange="showsub(this.value)" class="form-control">
              ...
              <?php
              $c=mysqli_query($con3,"select classid from staff_advisor where fid='$st' and classid='$classid'");

              while($res=mysqli_fetch_array($c))
              {
               $res1=mysqli_query($con3,"select *from class_details where classid='$classid' and active='YES'");
...
<table align="center">    &nbsp;
  ...
  &nbsp;                       
  <tr>
    <td> <a target='_blank' href="pdf_single_sub.php?subj=<?php echo "$s[0]";?>&dept=<?php echo "$dept";?>&e=<?php echo "$e";?>&sub_t=<?php echo "$sub_t";?>&bs=<?php echo "$bs";?>&cid=<?php echo "$cid";?>&cls=<?php echo "$class[0]";?>&cls2=<?php echo "$class[2]";?>&st=<?php echo "$st";?>&date1=<?php echo "$date1";?>&date2=<?php echo "$date2";?>&batch=<?php echo "$batch";?>">Print</a>&nbsp;&nbsp;&nbsp;&nbsp;
      <a target='_blank' href="excel1.php?subj=<?php echo "$s[0]";?>&dept=<?php echo "$dept";?>&e=<?php echo "$e";?>&sub_t=<?php echo "$sub_t";?>&bs=<?php echo "$bs";?>&cid=<?php echo "$cid";?>&cls=<?php echo "$class[0]";?>&cls2=<?php echo "$class[2]";?>&st=<?php echo "$st";?>&date1=<?php echo "$date1";?>&date2=<?php echo "$date2";?>&batch=<?php echo "$batch";?>">Export to Excel</a></td>
