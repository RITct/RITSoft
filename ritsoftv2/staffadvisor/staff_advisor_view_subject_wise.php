...
/**
 * @Author: indran
 * @Date:   2018-10-08 11:25:28
 * @Last Modified by:   indran
 * @Last Modified time: 2018-10-08 11:27:33
 */ 
						...
						{  
							...
							<tr>
								...
								while($rs3=mysqli_fetch_array($res3)) {
									...
									$res4=mysqli_query($con3,"select * from attendance where studid='$rs2[studid]' and date BETWEEN '$date1' AND '$date2' and subjectid='$rs3[subjectid]' and classid='$class[0]'");
									$res5=mysqli_query($con3,"select * from attendance where studid='$rs2[studid]' and date BETWEEN '$date1' AND '$date2' and subjectid='$rs3[subjectid]' and classid='$class[0]' and status='P'");
									?>
									<td><?php 
									...
									echo round(((mysqli_num_rows($res5)/mysqli_num_rows($res4))*100),0)."%"; ?></td>
									<?php
								...
								echo round((($present/$total)*100),0)."%"; ?></td>
								<td> <a href="attendance_search.php?date1=<?php echo "$date1";?>&date2=<?php echo "$date2";?>&admis=<?php echo $admis;?>&name=<?php echo "$name"; ?>&class=<?php echo "$class[0]";  ?>">View details </a></td>
							</tr>
							<?php
						}
						$j++;
