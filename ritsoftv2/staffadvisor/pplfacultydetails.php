...
server with default setting (user 'ritsoftv2' with ritsoftv2 password) */
...
//Retreving details from faculty_details
...
if($result = mysqli_query($link, $sql)){
    if(mysqli_num_rows($result) > 0){
       ...
       while($row = mysqli_fetch_array($result)){
        ...
        echo '<td> <a style=" position: absolute; top: 10%; right: 3%; " class="btn btn-sm btn-info" href="home.php">BACK</a> </td>';
        echo "<tr>";
