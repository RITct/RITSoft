...
if(isset($_POST['subjectid']))
{
    ...
    echo "<script>window.location.href='electiveview.php?id=$subid'</script>"; 
}
?>      
}
...
//reading student details
            $resul=mysql_query("SELECT current_class.studid,rollno FROM current_class WHERE current_class.classid='$classid' and current_class.studid  in(SELECT elective_student.stud_id from elective_student WHERE elective_student.sub_code='$subid') order by rollno");
            while($data=mysql_fetch_array($resul))
            {
              ...
              <tr >
                ...
                <td>
                    <div class="btn-group">
                        <a href="electremove.php?id=<?php echo $adm_no; ?>&sid=<?php echo $subid; ?>">REMOVE</a>
                    </div>
                </td>
            </tr>
            <?PHP
