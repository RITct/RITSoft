...
if(isset($_REQUEST['add_no'])){
    ...
    elseif(isset($search_query['0']))
      ...
      $sql = "SELECT A.* FROM class_details A INNER JOIN staff_advisor S ON A.classid=S.classid WHERE $query AND active like 'yes' AND S.fid='$fid' and classid=$classid";
