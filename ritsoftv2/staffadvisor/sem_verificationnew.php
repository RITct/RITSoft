...
$z11=mysql_query("select * from semregstatus where next_sem='$classid'") or die(mysql_error());
$r11=mysql_fetch_assoc($z11);
$next_sem=$r11["curr_sem"];
$classid=$next_sem;
?>
							...
							if($apv_status!="Not Approved")
								{ ?>
									...
									<br><div class="btn-group">
										<a onclick="return confirm('Do you really want to verify this request?');" href="semregeditnew.php?id=<?php echo $reg_id;?>&id2=1"><font color="green">Verify</font></a> | 
