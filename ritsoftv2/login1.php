...
if(isset($_POST['login']))
{
 ...
 //echo  mysql_error(); 
  ...
  // echo "<script>alert('Logged In Successfully')</script>";
     echo "<script>window.location.href='admin/desig.php'</script>";
   }
        ...
        <div class="w3-modal-content w3-animate-top w3-card-6">
          ...
          while ($i=mysql_fetch_assoc($result)) 
          {
            ...
            if($des=='principal')
            {
              ...
              <input type="submit" class="btn btn-primary btn-block" value="  PRINCIPAL  " onclick="window.location.href='principal/'" />
            ...
            else if($des=='ugdean')
            {
              ...
              <div class="col-md-4 ">
                <input type="submit" class="btn btn-primary btn-block" value="   UGDEAN   "  onclick="window.location.href='ugdean/'" />
              </div>
              <?php		
            }
            else if($des=='pgdean')
            {
              ...
              <div class="col-md-4">
                <input type="submit" class="btn btn-primary btn-block" value="   PGDEAN    " onclick="window.location.href='pgdean/'" />
              </div>
            ...
            { 
              ...
              <div class="col-md-4">
                <input type="submit" class="btn btn-primary btn-block" value="STAFF ADVISOR" onclick="window.location.href='staffadvisor/home.php'" />
              </div>
    ...
    <form id="login" method="post">
      <table>
        <tr>
          ...
          <td>
            <input type="text" name="username" class="form-control" placeholder="Username" required pattern="^[A-Za-z0-9@.\s]{2,50}$" title="Text contains only AlphaNumeric ,Space ,@ and Period" />
          </td>
        </tr>
        <tr>
          <td>
