...
if(isset($_POST['excel']))
{
  ...
  $sql = "SELECT classid FROM class_details WHERE courseid='$search_query[0]' AND semid='$search_query[1]' AND deptname='$search_query[3]' AND branch_or_specialisation='$search_query[2]'";
