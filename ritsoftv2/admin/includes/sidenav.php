            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                           <a href="desig.php"><i class="fa fa-table fa-fw"></i>Designation</a>
                           
                            <!-- /.nav-second-level -->
                        </li>
                        <li>
                           <a href="changeacdyear.php"><i class="fa fa-table fa-fw"></i>Change Academic Year</a>
                           
                            <!-- /.nav-second-level -->
                        </li>
                        
                        <li>
                           <a href="changeacd.php"><i class="fa fa-table fa-fw"></i>Add Academic Year</a>
